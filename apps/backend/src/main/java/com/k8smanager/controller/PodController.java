                ...
                kubernetesClient.apps().deployments()
                                ...
                                .forEach(d -> resources.add(new K8sResourceDTO(
                                                ...
                                                new ObjectMetadataDTO(
                                                                ...
                                                                d.getMetadata().getCreationTimestamp() != null
                                                                                ? java.time.Instant.parse(d
                                                                                                .getMetadata()
                ...
                kubernetesClient.apps().statefulSets()
                                ...
                                .forEach(s -> resources.add(new K8sResourceDTO(
                                                ...
                                                new ObjectMetadataDTO(
                                                                ...
                                                                s.getMetadata().getCreationTimestamp() != null
                ...
                kubernetesClient.apps().daemonSets()
                                ...
                                .forEach(ds -> resources.add(new K8sResourceDTO(
                                                ...
                                                new ObjectMetadataDTO(
                                                                ...
                                                                ds.getMetadata().getCreationTimestamp() != null
                                                                                ? java.time.Instant.parse(ds
                                                                                                .getMetadata()
                                                                                                .getCreationTimestamp())
                                                                                                .toEpochMilli()
                                                                                : 0,
                ...
                kubernetesClient.configMaps()
                                ...
                                .forEach(cm -> resources.add(new K8sResourceDTO(
                                                ...
                                                new ObjectMetadataDTO(
                                                                ...
                                                                cm.getMetadata().getCreationTimestamp() != null
                                                                                ? java.time.Instant.parse(cm
                                                                                                .getMetadata()
                                                                                                .getCreationTimestamp())
                                                                                                .toEpochMilli()
                                                                                : 0,
